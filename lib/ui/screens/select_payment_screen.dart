          ...
          children: <Widget>[
            ...
            Dismissible(
                ...
                confirmDismiss: (direction) async {
                  ...
                  if (couponCode == '') {
                    if (genCoupon == null) {
                      Navigator.pushNamed(context, RoutePaths.instaMojo,
                          arguments: InstamojoPaymentPage(indexPer, null));
                    } else {
                      Navigator.pushNamed(context, RoutePaths.instaMojo,
                          arguments: InstamojoPaymentPage(indexPer, genCoupon));
                    }
                  } else {
